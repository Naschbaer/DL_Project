...
flags.DEFINE_string('images', None, 'Path to the directory containing images you want to predict the labels for')
flags.DEFINE_boolean('is_training', True, 'train or test phase')
flags.DEFINE_boolean('predict', False, 'predict phase')
flags.DEFINE_integer('num_threads', 8, 'number of threads of enqueueing examples')
flags.DEFINE_string('logdir', 'logs', 'logs directory')
flags.DEFINE_integer('train_sum_freq', 500, 'the frequency of saving train summary(step)')
